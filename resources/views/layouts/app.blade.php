...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <title>{{ config('app.name', 'Wisata-Jepara') }}</title>
        <script src="{{ asset('js/app.js') }}"></script>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent fixed-top">
            <div class="container">
                <a class="navbar-brand" href="#">JEPARA</a>
        ...
        <div class="justify-content-center bg-primary">
            <footer class="footer">
                <span class="text-muted text-sm text-center d-sm-inline-block">Copyright © {{date('Y')}} Gigerbread . All rights reserved.</span>
            </footer>
        </div>
        @livewireScripts
